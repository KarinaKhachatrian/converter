...
class MainWindow(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.choose_lbl = QtWidgets.QLabel("Выберите директорию с PDF-файлами ОХЛП")

        self.choose_btn = QtWidgets.QPushButton("Выбрать директорию")
        self.process_btn = QtWidgets.QPushButton("Конвертировать файлы")
        self.cancel_btn = QtWidgets.QPushButton("Отмена")
        self.cancel_btn.setEnabled(False)

        self.selected_dir_lbl = QtWidgets.QLabel("Директория не выбрана")
